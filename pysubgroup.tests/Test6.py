...
task = SubgroupDiscoveryTask.SubgroupDiscoveryTask (data, target, searchSpace, resultSetSize=10, depth=2, qf=GeneralizationAwaresInterestingnessMeasures.GAStandardQF(0.5), minQuality=-9999999)
